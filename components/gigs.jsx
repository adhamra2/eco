...
function gigs(props) {
  ...
  return (
    <div className='bg-white rounded-md flex flex-wrap gap-3'>
        {props.products.map((product, index)=>(
              <div className="relative max-md:mx-auto mt-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                  <img className="object-cover" src={product.productImage[0].url} alt="product image" />
